...
#
# Changes:
# 2005-09-23  * example removed to use the library
#               (Alexandre David)
#             * added padding for labels in the tabs
...
#
# $Id: udbm-mdi.rb,v 1.2 2005/09/28 18:24:01 adavid Exp $
