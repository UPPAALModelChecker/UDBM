...
static size_t mingraph_bitMatrixFromCopy32(uint32_t* bitMatrix, const int32_t* mingraph, bool isUnpacked,
                                           raw_t* buffer);
static size_t mingraph_bitMatrixFromCopy16(uint32_t* bitMatrix, const int32_t* mingraph, bool isUnpacked,
                                           raw_t* buffer);
static size_t mingraph_bitMatrixFromBitMatrix32(uint32_t* bitMatrix, const int32_t* mingraph, bool isUnpacked,
                                                raw_t* buffer);
static size_t mingraph_bitMatrixFromBitMatrix16(uint32_t* bitMatrix, const int32_t* mingraph, bool isUnpacked,
                                                raw_t* buffer);
static size_t mingraph_bitMatrixFromCouplesij32(uint32_t* bitMatrix, const int32_t* mingraph, bool isUnpacked,
                                                raw_t* buffer);
static size_t mingraph_bitMatrixFromCouplesij16(uint32_t* bitMatrix, const int32_t* mingraph, bool isUnpacked,
                                                raw_t* buffer);
...
{
    static const hasZero_f hasZero[8] = {mingraph_copy32HasZero, mingraph_copy16HasZero, mingraph_errorHasZero,
                                         mingraph_errorHasZero,  mingraph_c32HasZero,    mingraph_c16HasZero,
...
size_t dbm_getBitMatrixFromMinDBM(uint32_t* bitMatrix, const int32_t* minDBM, bool isUnpacked, raw_t* buffer)
{
    ...
    static const bitMatrixDBM_f bitMatrixFromMinDBM[8] = {
        mingraph_bitMatrixFromCopy32,      mingraph_bitMatrixFromCopy16,      mingraph_bitMatrixError,
        mingraph_bitMatrixError,           mingraph_bitMatrixFromBitMatrix32, mingraph_bitMatrixFromBitMatrix16,
    ...
    /* dim > 1
     */
    return bitMatrixFromMinDBM[mingraph_getTypeIndexFromPtr(minDBM)](bitMatrix, minDBM, isUnpacked, buffer);
}
...
{
    fprintf(stderr, RED(BOLD) UDBM_PACKAGE_STRING " fatal error: invalid encoded DBM to test" NORMAL "\n");
    exit(2);
    return false;
}
...
static cindex_t mingraph_readError(raw_t* dbm, const int32_t* mingraph)
{
    fprintf(stderr, RED(BOLD) UDBM_PACKAGE_STRING " fatal error: invalid encoded DBM to read" NORMAL "\n");
    exit(2);
 ...
 */
static size_t mingraph_addMissingConstraints(uint32_t* matrix, const int32_t* mingraph, raw_t* dbm, cindex_t dim,
 ...
 * Complexity: O(dim^2)
 */
static size_t mingraph_bitMatrixFromBitMatrix32(uint32_t* matrix, const int32_t* mingraph, bool isUnpacked,
                                                raw_t* buffer)
{
    cindex_t dim = mingraph_readDimFromPtr(mingraph);
    size_t nbConstraints = mingraph_getNbConstraints(mingraph);
...
/* Similar to previous */
static size_t mingraph_bitMatrixFromBitMatrix16(uint32_t* matrix, const int32_t* mingraph, bool isUnpacked,
                                                raw_t* buffer)
{
    cindex_t dim = mingraph_readDimFromPtr(mingraph);
    size_t nbConstraints = mingraph_getNbConstraints(mingraph);
...
static size_t mingraph_bitMatrixFromCouplesij32(uint32_t* matrix, const int32_t* mingraph, bool isUnpacked, raw_t* dbm)
{
    uint32_t info = mingraph_getInfo(mingraph);
    cindex_t dim = mingraph_readDim(info);
    size_t nbConstraints = mingraph_getNbConstraints(mingraph);
...
/* Similar to previous */
static size_t mingraph_bitMatrixFromCouplesij16(uint32_t* matrix, const int32_t* mingraph, bool isUnpacked, raw_t* dbm)
{
    uint32_t info = mingraph_getInfo(mingraph);
    cindex_t dim = mingraph_readDim(info);
    uint32_t bitSize = (uint32_t)(1 << (mingraph_typeOfIJ(info) + 2));
