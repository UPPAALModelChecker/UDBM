...
static relation_t mingraph_relationWithCopy32(const raw_t* dbm, cindex_t dim, const int32_t* mingraph,
                                              raw_t* unpackBuffer, bool* isExact);
static relation_t mingraph_relationWithCopy16(const raw_t* dbm, cindex_t dim, const int32_t* mingraph,
                                              raw_t* unpackBuffer, bool* isExact);
static relation_t mingraph_relationWithMinBitMatrix32(const raw_t* dbm, cindex_t dim, const int32_t* mingraph,
                                                      raw_t* unpackBuffer, bool* isExact);
static relation_t mingraph_relationWithMinBitMatrix16(const raw_t* dbm, cindex_t dim, const int32_t* mingraph,
                                                      raw_t* unpackBuffer, bool* isExact);
static relation_t mingraph_relationWithMinCouplesij32(const raw_t* dbm, cindex_t dim, const int32_t* mingraph,
                                                      raw_t* unpackBuffer, bool* isExact);
static relation_t mingraph_relationWithMinCouplesij16(const raw_t* dbm, cindex_t dim, const int32_t* mingraph,
                                                      raw_t* unpackBuffer, bool* isExact);
...
relation_t dbm_relationWithMinDBM(const raw_t* dbm, cindex_t dim, const int32_t* minDBM, raw_t* unpackBuffer)
{
     ...
     */
    if (*minDBM == 1) {
        return (dim == 1 && *dbm == dbm_LE_ZERO) ? (unpackBuffer ? base_EQUAL : base_SUBSET) : base_DIFFERENT;
    }
