...
namespace dbm
{
    ...
    public:
        ...
        int32_t* writeToMinDBMWithOffset(bool minimizeGraph, bool tryConstraints16,
                                         allocator_t c_alloc, uint32_t offset) const;
    ...
    inline int32_t* pdbm_t::writeToMinDBMWithOffset(bool minimizeGraph, bool tryConstraints16,
                                                    allocator_t c_alloc, uint32_t offset) const
    {
        return pdbm_writeToMinDBMWithOffset(pdbm, dim, minimizeGraph, tryConstraints16, c_alloc,
                                            offset);
    }
