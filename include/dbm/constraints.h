 ...
 */
static inline raw_t dbm_bound2raw(int32_t bound, strictness_t strict)
{
    return (bound * 2) | strict;
}
 ...
 */
#ifdef __cplusplus
static inline raw_t dbm_boundbool2raw(int32_t bound, bool isStrict)
{
 ...
 */
static inline strictness_t dbm_negStrict(strictness_t strictness)
{
...
static inline raw_t dbm_addRawRaw(raw_t x, raw_t y)
{
    ...
    return (x == dbm_LS_INFINITY || y == dbm_LS_INFINITY) ? dbm_LS_INFINITY
                                                          : (x + y) - ((x | y) & 1);
}
 ...
 */
static inline constraint_t dbm_constraint(cindex_t i, cindex_t j, int32_t bound,
 ...
 */
static inline constraint_t operator!(const constraint_t& c)
{
 ...
 */
inline bool constraint_t::operator==(const constraint_t& b) const
{
